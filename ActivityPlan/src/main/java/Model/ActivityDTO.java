...
public class ActivityDTO {
	...
	public ActivityDTO(int act_seq, String act_name, String act_sdate, String act_edate, String act_intro,
			String act_benefits, String act_center, String act_money, String act_category, String act_homepage,
			String act_poster) {
		super();
